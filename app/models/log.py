...
class LogAction(str):
    ...
    CREDIT_DELETED = "CREDIARIO_EXCLUIDO"
    ...
    CHARGE_REPRINTED = "COBRANCA_REIMPRESSA"
    CHARGE_CANCELLED = "COBRANCA_CANCELADA"
    BANK_ACCOUNT_CREATED = "CONTA_CRIADA"
    BANK_ACCOUNT_UPDATED = "CONTA_EDITADA"
    BANK_ACCOUNT_DELETED = "CONTA_EXCLUIDA"
